...
<?php
    ...
    include_once(ABSOLUTE_PATH . '/classes/fruit_product.class.php'); //error 12: added include statement for fruit class
	...
	$aryProductArray = unserialize($_SESSION['aryProductArray']); //error 13: deleted 's' after variable name 'aryProductArray'
