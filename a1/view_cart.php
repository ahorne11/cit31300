...
<?php
	...
	$aryProductArray = unserialize($_SESSION['aryProductArray']); //error 10: deleted 's' after variable name 'aryProductArray'
	...
	for ($x=0; $x < count($aryCartArray); $x++) {
		...
		$thisProduct = $aryProductArray[$aryCartItemArray[0]]; //error 9: no semicolon //error 11: deleted 's' after variable name 'aryProductArray'
